...
// NewServerPlanOp は ServerPlanAPI 実装を返す。
func NewServerPlanOp(c *client.Client) ServerPlanAPI {
...
func (op *serverPlanOp) List(ctx context.Context, req *client.ServerPlanFindRequest) (*client.ServerPlanFindResponseEnvelope, error) {
	...
	resp, err := op.client.ServerPlanOpFind(ctx, params)
	if err != nil {
		return nil, wrapOpErr("ServerPlan.List", err)
	}
	return resp, nil
}
