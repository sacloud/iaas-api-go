...
// NewInternetPlanOp は InternetPlanAPI 実装を返す。
func NewInternetPlanOp(c *client.Client) InternetPlanAPI {
...
func (op *internetPlanOp) List(ctx context.Context, req *client.InternetPlanFindRequest) (*client.InternetPlanFindResponseEnvelope, error) {
	...
	resp, err := op.client.InternetPlanOpFind(ctx, params)
	if err != nil {
		return nil, wrapOpErr("InternetPlan.List", err)
	}
	return resp, nil
}
