...
// NewServiceClassOp は ServiceClassAPI 実装を返す。
func NewServiceClassOp(c *client.Client) ServiceClassAPI {
...
func (op *serviceClassOp) List(ctx context.Context, req *client.ServiceClassFindRequest) (*client.ServiceClassFindResponseEnvelope, error) {
	...
	resp, err := op.client.ServiceClassOpFind(ctx, params)
	if err != nil {
		return nil, wrapOpErr("ServiceClass.List", err)
	}
	return resp, nil
}
