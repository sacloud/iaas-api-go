...
### 14. レスポンスに含まれる平文 Password フィールドの整理 ✅ 対応済み
...
### 15. リリース・バージョニング方針が README 記述のみ
...
### 18. TypeSpec を source of truth に昇格するロードマップ未定
...
4. ドキュメント（低 15〜18）はリリース判断前にまとめて更新
