...
func addClientFactoryHooks() {
	...
	iaas.AddClientFacotyHookFunc("WebAccel", func(in interface{}) interface{} {
		return NewWebAccelTracer(in.(iaas.WebAccelAPI))
	})
...
func NewWebAccelTracer(in iaas.WebAccelAPI) iaas.WebAccelAPI {
...
func (t *WebAccelTracer) List(ctx context.Context) (*iaas.WebAccelListResult, error) {
	...
	targetResults := struct {
		Result *iaas.WebAccelListResult
		Error  error
	}{
		Result: result,
		Error:  err,
...
func (t *WebAccelTracer) CreateCertificate(ctx context.Context, id types.ID, param *iaas.WebAccelCertRequest) (*iaas.WebAccelCerts, error) {
	...
	targetArguments := struct {
		Argid    types.ID                  `json:"id"`
		Argparam *iaas.WebAccelCertRequest `json:"param"`
	}{
		Argid:    id,
		Argparam: param,
	}
...
func (t *WebAccelTracer) DeleteAllCache(ctx context.Context, param *iaas.WebAccelDeleteAllCacheRequest) error {
	...
	targetArguments := struct {
		Argparam *iaas.WebAccelDeleteAllCacheRequest `json:"param"`
	}{
		Argparam: param,
	}
	if d, err := json.Marshal(targetArguments); err == nil {
...
func (t *WebAccelTracer) DeleteCache(ctx context.Context, param *iaas.WebAccelDeleteCacheRequest) ([]*iaas.WebAccelDeleteCacheResult, error) {
	...
	targetArguments := struct {
		Argparam *iaas.WebAccelDeleteCacheRequest `json:"param"`
	}{
		Argparam: param,
	}
	if d, err := json.Marshal(targetArguments); err == nil {
